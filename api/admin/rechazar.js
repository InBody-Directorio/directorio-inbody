...
<tr><td style="background:${COLOR_BLACK};padding:32px;">
  ...
  <div style="color:white;font-size:24px;font-weight:700;margin-top:8px;line-height:1.3;font-family:${DISPLAY_FONT_STACK};">Sobre tu solicitud</div>
</td></tr>
<tr><td style="padding:32px;">
  ...
  <div style="background:${COLOR_BG};border-radius:12px;padding:20px 24px;margin-bottom:24px;border-left:3px solid ${COLOR_RED};">
    <div style="font-size:11px;font-weight:600;color:${COLOR_RED};letter-spacing:0.12em;text-transform:uppercase;margin-bottom:6px;">Motivo</div>
    <div style="font-size:14px;color:${COLOR_BLACK};line-height:1.6;">${escapeHTML(motivo)}</div>
  </div>` : ''}
  <p style="margin:0 0 16px;font-size:14px;color:${COLOR_COOL_GRAY};line-height:1.7;">
