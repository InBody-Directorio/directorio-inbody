...
export default function Sidebar({ profesionales, loading, selectedId, onSelect }) {
  return (
    <aside className="w-[380px] flex-shrink-0 bg-white border-r border-neutral-200/70 flex flex-col h-full">
      <div className="px-5 py-3.5 border-b border-neutral-150 flex items-center justify-between flex-shrink-0">
        <div>
          <div className="text-[10px] uppercase tracking-[0.12em] text-neutral-400 font-semibold mb-1">
            Resultados
          </div>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
      ...
      <div className="text-sm font-medium text-neutral-900 mb-1">Sin resultados</div>
